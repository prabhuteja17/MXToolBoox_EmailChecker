...
def main():
    ...
    if domains:
        results_df = pd.DataFrame(columns=["Domain", "DNS Records Found", "MX Records Found", "Mail Server 1 Hostname", "Mail Server 1 IPv4", "Email Service Provider"])
        ...
        for domain in domains:
            ...
            if result:
                ...
                mx_records_found = "Yes" if result.get('Passed') else "No"
                ...
                results_df = results_df._append({"Domain": domain, 
                                                ...
                                                "MX Records Found": mx_records_found,
